...
if(c!=null || p!=null)
{
   ...
   {
 out.println("<font color=red><b>Check empty fields</b></font>");
    }
else
{
   int x=0;
   PreparedStatement ps=con.prepareStatement("insert into candidate(cname,pname,nov) values(?,?,?)");
   ps.setString(1,c);
   ps.setString(2,p);
   ...
   x=ps.executeUpdate();
  if(x==1)
      out.println("<font color=red><b>Candidate saved Successfully !</b></font>");
...
<form id="form1" method="post" action="">
        <table width="431" height="134" >
          <tr>
            <th width="181" height="20" scope="row"> Candidate Name </th>
            <td width="234">
              <p>
                <label>
